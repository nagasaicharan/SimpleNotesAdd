package com.example.nagasaicharan.assignmentpeepstake.data;
 ...
 *  This class is going to hide all of the functionality that's used to put, get items from the shared preferences data storage.
